...
const categories = [
  ...
  },
  {
    ...
    canonicalUrl: `${BASE_URL}/category/account`,
    breadcrumbs: [
      { name: 'Home', url: BASE_URL },
      { name: 'Categories', url: `${BASE_URL}/shop` },
      { name: 'Account', url: `${BASE_URL}/category/account` },
    ],
    bodyH1: 'Verified Developer, Marketplace & Ad Accounts',
    bodyContent: '<p class="text-slate-600 mb-4">Explore verified accounts for Amazon, Apple Developer, Google Play, Facebook Ads, Google Ads, GitHub, TikTok, Twitter, Bing, Taboola, and Outbrain.</p>',
  },
  {
    slug: 'other',
    name: 'Other',
    ...
    canonicalUrl: `${BASE_URL}/category/other`,
    breadcrumbs: [
      { name: 'Home', url: BASE_URL },
      { name: 'Categories', url: `${BASE_URL}/shop` },
      { name: 'Other', url: `${BASE_URL}/category/other` },
    ],
    bodyH1: 'Specialized Identity Verification & Virtual VoIP Assets',
    bodyContent: '<p class="text-slate-600 mb-4">Verified US SSN numbers, state driving license records, aged PVA Gmail accounts, Google Voice phone numbers, and TextNow virtual accounts.</p>',
  },
];
...
const products = [
  ...
  // New Account products
  {
    ...
    rating: '4.9',
    reviewCount: '142',
    description: 'Buy verified Amazon buyer and seller accounts with active purchase history and approved selling privileges.',
  },
  {
    ...
    rating: '4.9',
    reviewCount: '98',
    description: 'Verified Apple Developer personal and enterprise business enrollment accounts ready for instant iOS and macOS app publishing.',
  },
  {
    ...
    rating: '4.9',
    reviewCount: '112',
    description: 'Verified Google Play developer console accounts ready for Android app deployment with clean history and fast delivery.',
  },
  {
    ...
    rating: '4.8',
    reviewCount: '215',
    description: 'Verified Meta Facebook Ads accounts with reinstated advertising access, high daily spend limits, and warmed pixel profiles.',
  },
  {
    ...
    rating: '4.8',
    reviewCount: '178',
    description: 'Aged GitHub developer accounts with green contribution history, active repositories, stars, and authentic developer followers.',
  },
  {
    id: 'buy-google-ads-accounts',
    name: 'Buy Google Ads Accounts',
    category: 'Account',
    categorySlug: 'account',
    startingPrice: '100',
    rating: '4.9',
    reviewCount: '264',
    description: 'Pre-warmed Google Ads accounts with verified advertiser billing, active campaigns history, and high spending thresholds.',
  },
  {
    ...
    rating: '4.7',
    reviewCount: '87',
    description: 'Approved Taboola native advertising publisher and advertiser accounts ready for high-ROI native traffic campaigns.',
  },
  {
    ...
    rating: '4.8',
    reviewCount: '134',
    description: 'Verified Microsoft Bing Ads accounts with verified payment methods and active search advertising approval.',
  },
  {
    ...
    rating: '4.9',
    reviewCount: '192',
    description: 'Verified TikTok Ads agency and standard accounts with worldwide targeting, unlocked BC, and high ad spend limits.',
  },
  {
    ...
    rating: '4.7',
    reviewCount: '76',
    description: 'Approved Snapchat Ads business manager accounts with verified billing profile and unrestricted ad set limits.',
  },
  {
    ...
    rating: '4.8',
    reviewCount: '105',
    description: 'Verified X (Twitter) Ads accounts with verified credit profile, gold/blue check badge compatibility, and clean engagement.',
  },
  {
    ...
    rating: '4.7',
    reviewCount: '63',
    description: 'Verified Outbrain native advertising network accounts for international traffic arbitrage and high-converting native placements.',
  },
  // New Other products
  {
    id: 'buy-verified-ssn-number',
    name: 'Buy Verified SSN Number',
    category: 'Other',
    categorySlug: 'other',
    startingPrice: '100',
    rating: '4.8',
    reviewCount: '128',
    description: 'Verified US Social Security Number identification documentation records for identity verification and account compliance.',
  },
  {
    ...
    rating: '4.8',
    reviewCount: '145',
    description: 'Verified high-resolution front and back driving license records from various US states and international jurisdictions.',
  },
  {
    ...
    rating: '4.7',
    reviewCount: '167',
    description: 'Aged TextNow VoIP phone number accounts for SMS verification, business calls, and private online communications.',
  },
  {
    ...
    rating: '4.9',
    reviewCount: '310',
    description: 'Aged Google Gmail PVA accounts registered between 2014 and 2023 with established activity, recovery details, and 100% login guarantee.',
  },
  {
    ...
    rating: '4.9',
    reviewCount: '284',
    description: 'Permanent Google Voice virtual numbers linked to aged Gmail accounts with full 2FA recovery credentials and unlimited incoming texts.',
  },
];
